...
Usuario.prototype._getFullName = () => {
    return `${this.nombre} ${this.apellido}`
}
Usuario.prototype._addMascota = (mascota) => {
    mascotas.push(mascota)
}
Usuario.prototype._countMascota = () =>{
    return mascotas.length;
}
Usuario.prototype._addBook = (nombre, autor, nroPaginas ) => {
    libros.push({
        nombre: nombre,
        autor: autor,
...
Usuario.prototype._getBookNames = () => {
    return libros.map( (item) => {return item.nombre;});
